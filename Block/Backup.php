...
class Aschroder_CloudBackup_Block_Backup extends Mage_Adminhtml_Block_Template {
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('offsiteBackupsGrid',
            $this->getLayout()->createBlock('cloudbackup/backup_grid')
        );
    }
    ...
    {
        return $this->getChildHtml('offsiteBackupsGrid');
    }
}
